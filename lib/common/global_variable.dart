...
/// 全局颜色
const Color THEME_COLOR = Color(0xff2D88FF);
...
const MaterialColor themeColor = const MaterialColor(
  0xff0080BF,
  const <int, Color>{
    50: const Color(0xff0080BF),
    100: const Color(0xff0080BF),
    200: const Color(0xff0080BF),
    300: const Color(0xff0080BF),
    400: const Color(0xff0080BF),
    500: const Color(0xff0080BF),
    600: const Color(0xff0080BF),
    700: const Color(0xff0080BF),
    800: const Color(0xff0080BF),
    900: const Color(0xff0080BF),
  },
);
