...
class SendGroupRedPage extends StatefulWidget {
  @override
  _SendGroupRedPageState createState() => _SendGroupRedPageState();
}

class _SendGroupRedPageState extends State<SendGroupRedPage> {
  String money = "0.00";
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            margin: EdgeInsets.only(left: 39, top: 3),
            height: 14,
