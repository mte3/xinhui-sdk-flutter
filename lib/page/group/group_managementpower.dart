...
class ChangeManagementPower extends StatefulWidget {
  @override
  _ChangeManagementPowerState createState() => _ChangeManagementPowerState();
}

class _ChangeManagementPowerState extends State<ChangeManagementPower> {
  List testList = [
    {
