...
import 'package:jh_im_sdk/api/column_list_view_model.dart';
import 'package:jh_im_sdk/api/home_model.dart';
...
class HomeViewModel extends BaseViewModel {
  ...
  Future<ResponseModel> getHome(
    ...
    ResponseModel data = await HomeRequestModel(
      ...
      false, // 是否为post请求，false的话就是get请求
...
//      Map data = rep['data']; // 从数据内使用下标形式拿到data数据
      ...
      print("eeee====> $e"); // 打印异常
      return ResponseModel.fromError("错误", 10);
    });
    return data;
  }
}
