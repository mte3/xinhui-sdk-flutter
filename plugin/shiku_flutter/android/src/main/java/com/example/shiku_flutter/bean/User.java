package com.example.shiku_flutter.bean;
...
import com.example.shiku_flutter.util.Constants;
import com.example.shiku_flutter.util.PreferenceUtils;
import com.example.shiku_flutter.util.StringUtils;
...
public class User implements Parcelable, Cloneable {
     ...
     * @return
     */
    public String getTelephoneNoAreaCode(Context ctx) {
        String areaCode = String.valueOf(PreferenceUtils.getInt(ctx, Constants.AREA_CODE_KEY, 86));
        // 删除开头的区号，
