//package com.example.shiku_flutter.socket;
//
...
//
//import com.example.shiku_flutter.socket.msg.ChatMessage;
//import com.example.shiku_flutter.socket.msg.ExitGroupMessage;
//import com.example.shiku_flutter.socket.msg.JoinGroupMessage;
//import com.example.shiku_flutter.socket.msg.MessageHead;
//import com.example.shiku_flutter.socket.msg.PullBatchGroupMessage;
//import com.example.shiku_flutter.socket.protocol.TcpPacket;
//import com.example.shiku_flutter.socket.protocol.TcpServerDecoder;
//import com.example.shiku_flutter.ui.base.CoreManager;
//import com.example.shiku_flutter.util.LogUtils;
//import com.example.shiku_flutter.xmpp.NotifyConnectionListener;
//import com.example.shiku_flutter.xmpp.listener.AuthStateListener;
//import com.example.shiku_flutter.xmpp.listener.ChatReceiptListener;
...
//
//    public EMConnectionManager(Context context,Context ctx) {
//        SOCKET_HOST = CoreManager.requireConfig(context).XMPPHost;
//
//        mCurrentLoginUserToken = CoreManager.requireSelfStatus(ctx).accessToken;
//        mCurrentLoginUserId = CoreManager.requireSelf(ctx).getUserId();
...
//                        mMainHandler.post(() -> ToastUtil.showToast(ctx, ctx.getString(R.string.not_allow_send_by_dangerous_char, errorMessage.getArg())));
//                    }
//                }
